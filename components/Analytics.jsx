            ...
            </div>
            {
                loading ?
                    ...
                    <div className="flex grow justify-around  gap-28 flex-wrap">
                        ...
                        <div className="stat-box bg-gradient-to-r from-pink-200 to-pink-400 border-b-4 border-pink-600 rounded-md shadow-xl">
                            <div className="stat-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                        ...
                        <div className="stat-box bg-gradient-to-r from-yellow-100 to-yellow-300 border-b-4 border-yellow-600 rounded-md shadow-xl">
                            <div className="stat-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                        ...
                        <div className="stat-box bg-gradient-to-l from-sky-100 to-sky-300 border-b-4 border-sky-600 rounded-md shadow-xl">
                            <div className="stat-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                        ...
                        <div className="stat-box bg-gradient-to-l from-orange-100 to-orange-300 border-b-4 border-orange-600 rounded-md shadow-xl">
                            <div className="stat-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                        ...
                        <div className="stat-box bg-gradient-to-l from-gray-200 to-gray-400 border-b-4 border-gray-600 rounded-md shadow-xl">
                            <div className="stat-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
