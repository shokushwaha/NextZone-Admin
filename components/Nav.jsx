...
export default function Nav({ show }) {
    ...
    const inactiveLink = 'flex gap-1 p-1 text-gray-400';
    const activeLink = inactiveLink + ' bg-textTertiary font-bold rounded-sm text-textSecondary';
    const inactiveIcon = 'w-6 h-6 ';
    const activeIcon = inactiveIcon + ' text-textPrimary';
    ...
    return (
        <>
            <aside className={(show ? "left-0" : "-left-full") + "  top-0 text-gray-500 p-4  fixed w-full bg-bgSecondary  min-h-screen -left-full md:static md:w-auto transition-all"}>
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    <button
                        onClick={logOut}
                        className="inactiveLink flex gap-2 text-red-500 mt-2 ">
